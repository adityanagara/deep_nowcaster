...
def build_DCNN_softmax_mod_special_refl(input_var_refl = None):
    ...
    print('Single Convolution layer with only the reflectivity variable and 8 filters')
    # Define the input variable which is 4 frames of IPW fields and 4 frames of 
    # reflectivity fields
#    l_in_ipw = lasagne.layers.InputLayer(shape = (None,4,33,33),
#                                        input_var = input_var_ipw)
...
def load_data_to_memory(point_files,val_indices):
    ...
    process
    '''
    base_path = '/project/uma_michael_zink/deep_nowcaster/data/TrainTest/points_regression/'
    val_batches = []
    X_train_full_data = []
