# -*- coding: utf-8 -*-
"""
Created on Sun Aug  7 16:10:49 2016
...
def fit_cca_mdl(data_builder):
    '''Fit the CCA model first
    '''
...
def RF_classifier(train_files,validation_files,n_estimators = 100,feature_set = 'ipw_refl'):
    ...
    for tr,val in zip(train_files,validation_files):
        ...
        mdl = RandomForestClassifier(n_estimators = n_estimators,n_jobs = -1,max_features = 'auto')
...
#        performance_validation.mdl = mdl
        models.append((performance_validation,performance_train,mdl))
