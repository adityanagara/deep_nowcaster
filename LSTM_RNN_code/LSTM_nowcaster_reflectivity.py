...
#        print b[0].shape,b[1].shape
    ...
    model = Sequential()
    model.add(LSTM(1024, input_shape = (4,33*33),return_sequences=False))
    model.add(Dense(1))
    ...
    model.save_weights('my_model_weights_reflectivity.h5')
    f1 = file('results_reflectivity.pkl','w+')
