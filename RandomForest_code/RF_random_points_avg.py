...
mdl = RandomForestClassifier(n_estimators = 250,n_jobs = -1,class_weight = 'auto')
X_train, X_test = data_set[:1059000,:8],data_set[1059000:,:8]
Y_train, Y_test = data_set[:1059000,-1],data_set[1059000:,-1]
...
#        kf_num+=1
#    print tr
#    f1_averages.append(sum(temp_f1)/float(len(temp_f1)))
#    print sum(temp_f1)/float(len(temp_f1))
#
#
#
#model_metrics_file = file('model_metrics/RF_ipw_refl_avg.pkl','wb')
#
