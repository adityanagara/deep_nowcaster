...
for s in sites:
    ...
    base_path = '/home/aditya/UMASS/DFWnetDB' + os.sep + s[-1] + '/2015/' +doy  + os.sep + 'met_'+ s[0] + '.' + str(yr)[-2:] + doy
...
writeData.to_csv('IPW' + str(yr) + str(d.tm_mon).zfill(2) + str(d.tm_mday).zfill(2) + '.csv',index=False)
writeDataPres.to_csv('PR' + str(yr) + str(d.tm_mon).zfill(2) + str(d.tm_mday).zfill(2) + '.csv',index=False)
writeDataTemp.to_csv('Temp' + str(yr) + str(d.tm_mon).zfill(2) + str(d.tm_mday).zfill(2) + '.csv',index=False)
